...
WebSocket::WebSocket(EthernetInterface *ethptr_, char * url) : ethptr(ethptr_) {
    fillFields(url);
}
...
bool WebSocket::connect() {
    ...
    printf(cmd, "Upgrade: WebSocket\r\n");
    sprintf(cmd, "Upgrade: WebSocket\r\n");
    write(cmd, strlen(cmd));

    printf(cmd, "Connection: Upgrade\r\n");
